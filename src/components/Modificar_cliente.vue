<template>
  <div id="d6">
    <div id="d7">
      ...
      <button v-on:click="guardarCliente" >Guardar Cambios </button>
...
export default {
    ...
    methods:{
      guardarCliente: function(){
        ...
        axios.put("https://gestionatecback.herokuapp.com/cliente/registroPut", this.datosJSON, {headers: {}})
        ...
        .catch(error=>{
          ...
          alert("No se pudo modificar el cliente " + error.response.status)
